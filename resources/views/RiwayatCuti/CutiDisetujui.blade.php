<h1 class="text-3xl font-bold text-center mb-5">Riwayat Cuti Yang Disetujui</h1>
<div class="flex flex-col">
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div class="overflow-hidden">
                <table class="min-w-full" id="approvedTable">
                        ...
                        @foreach ($requests as $request)
                            @if ($request->request_status_id === 2)
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm bg-green-500 text-white font-light px-6 py-4 whitespace-nowrap">
